...
public class QRCodeKit {
    ...
    public static final int QRCODE_DEFAULT_HEIGHT = 900;

    public static final int QRCODE_DEFAULT_WIDTH = 900;
...
//        File logoFile = new File("D:\\zlkj\\fileUpload\\11595782-0ae3-41dc-b7b9-277826d95b91.png");
//        BufferedImage image = QRCodeKit.createQRCodeWithLogo(data, logoFile);
//        ImageIO.write(image, "png", new File("C:\\Users\\apple\\Desktop\\qrcode.jpg"));
