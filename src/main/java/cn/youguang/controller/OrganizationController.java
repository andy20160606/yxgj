...
public class OrganizationController {
    ...
    public List<Organization> treeGrid() {
        List<Organization> treeGrid = organizationService.findOrgTop();
        return treeGrid;
    }
    ...
    @RequestMapping("/add")
    @ResponseBody
    public Result add(Organization organization, Long pid) {
        Result result = new Result();
        try {
            if (pid != null)
                organization.setParent(organizationService.findOrgById(pid));
    ...
    @RequestMapping("/edit")
    @ResponseBody
    public Result edit(Organization organization, Long pid) {
        Result result = new Result();
        try {
            if (pid != null)
                organization.setParent(organizationService.findOrgById(pid));
